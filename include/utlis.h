...
void print_first_k_element(const std::string& name, const int8_t *arr, int k, int start_idx = 0);
void print_first_k_element(const std::string& name, const int32_t *arr, int k, int start_idx = 0);
void print_first_k_element(const std::string& name, const float *arr, int k, int start_idx = 0);
